...
const privatePath = /(^|\/)(\.release|\.dart_tool|build|node_modules)\/|\.(jks|keystore|apk|aab)$|firebase-adminsdk|firebase-service-account|google-services\.json|key\.properties$/i;
